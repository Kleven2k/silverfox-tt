...
real UART/SPI/I2C programs show wheter 32 instructions is enough.
...
afte the SET executes, not the same cycle. This is standard synchronous
...
correspondance with the organizers.
